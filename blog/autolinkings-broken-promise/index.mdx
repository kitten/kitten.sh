...
This is uniquely challenging, especially if you're new to Expo, but the problems
run deeper than build errors that you may see after an Expo SDK upgrade.
...
in your dependencies. It supports being invoked for both Expo module and React Native
...
to remove recommendations of any particular package manager.
...
This does however change its behaviour from the Community CLI's implementation of autolinking
and what you may be used to.
